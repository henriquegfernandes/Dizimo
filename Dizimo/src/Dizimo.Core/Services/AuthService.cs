...
public class AuthService
{
    ...
    public AuthService(string? storagePath = null)
    {
        // Default to local application data folder if available; allow injection for tests
        _path = storagePath ?? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "dizimo_users.json");
        Load();
    }
