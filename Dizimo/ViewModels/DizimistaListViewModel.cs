...
public partial class DizimistaListViewModel : ObservableObject
{
    ...
    // Propriedades públicas para acesso aos campos privados
    public ObservableCollection<Dizimista> Dizimistas
    {
        get => _dizimistas;
        private set
        {
            // Não é possível usar ref em campo readonly, então substitua o campo inteiro.
            // Remova o modificador 'readonly' do campo '_dizimistas' para permitir a atribuição.
