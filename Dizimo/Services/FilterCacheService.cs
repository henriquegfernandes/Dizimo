...
public class FilterCacheService : IFilterCacheService
{
    ...
    public void SaveOfertaListFilters(DateTime? dataInicio, DateTime? dataFim, string nome, string tipoPagamento)
    {
        ...
        System.Diagnostics.Debug.WriteLine("[FilterCache] Filtros de ofertas salvos em cache");
    }
    ...
    public (DateTime? dataInicio, DateTime? dataFim, string nome, string tipoPagamento)? GetOfertaListFilters()
    {
        try
        {
            ...
            System.Diagnostics.Debug.WriteLine("[FilterCache] Filtros de ofertas restaurados do cache");
            return (parsedDataInicio, parsedDataFim, nome ?? string.Empty, tipoPagamento ?? DefaultTipoPagamento);
        }
        catch (FormatException ex)
        {
            System.Diagnostics.Debug.WriteLine($"[FilterCache] Erro ao restaurar filtros de ofertas: {ex.Message}");
            return null;
        }
    }
    ...
    public void ClearOfertaListFilters()
    {
        ...
        System.Diagnostics.Debug.WriteLine("[FilterCache] Filtros de ofertas limpos do cache");
    }
    ...
    public void SaveDizimistaListFilters(string status, string nome)
    {
        ...
        System.Diagnostics.Debug.WriteLine("[FilterCache] Filtros de dizimistas salvos em cache");
    }
    ...
    public (string status, string nome)? GetDizimistaListFilters()
    {
        try
        {
            ...
            // Se nenhum filtro foi salvo, retorna null
            if (string.IsNullOrEmpty(status) && string.IsNullOrEmpty(nome))
            {
                return null;
            }

            System.Diagnostics.Debug.WriteLine("[FilterCache] Filtros de dizimistas restaurados do cache");
            return (status ?? DefaultTipoPagamento, nome ?? string.Empty);
        }
        catch (FormatException ex)
        {
            System.Diagnostics.Debug.WriteLine($"[FilterCache] Erro ao restaurar filtros de dizimistas: {ex.Message}");
            return null;
        }
    }
    ...
    public void ClearDizimistaListFilters()
    {
        ...
        System.Diagnostics.Debug.WriteLine("[FilterCache] Filtros de dizimistas limpos do cache");
    }
}
