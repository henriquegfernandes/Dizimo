...
public class PerfilToStringConverter : IValueConverter
{
    ...
    {
        if (value is PerfilUsuario perfil) return perfil == PerfilUsuario.Admin ? "Administrador" : "Padr�o";
    ...
    {
        if (value is string str) return str == "Administrador" ? PerfilUsuario.Admin : PerfilUsuario.Padrao;
