...
public interface IOfertaRepository
{
    ...
    Task<decimal> GetTotalValorAsync(DateTime? dataInicio = null, DateTime? dataFim = null,
        string? tipoPagamento = null, string? filtroNome = null);

    Task<PaginatedResult<Oferta>> GetAllPaginatedAsync(int pageNumber, int pageSize, DateTime? dataInicio = null,
